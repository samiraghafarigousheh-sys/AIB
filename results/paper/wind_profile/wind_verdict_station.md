...
**100.0 % of the -4.73 kWh comes from hours with real, non-zero wind**, and the above-pivot band alone carries -5.08 kWh (107.5 %) over 5,255 hours. The exactly-zero bucket — the entire content of the earlier finding — is now 138 hours and +0.00 kWh, 0.0 % of the total.
...
Of the hours the dynamic model adds to the cooling plant (3), the mean wind is 3.23 m/s and 0.0 % read exactly zero — against 96 % on the RO file, where the added hours *were* the fabricated calms.
